...
# Create a dictionary to map city names to their groups
group_lk = df.set_index('name')['group'].to_dict()

# Function to draw bar chart for a specific year
def draw_barchart(year):
    ...
    ax.text(0, 1.12, 'The most populous cities in the world from 1500 to 2018', transform=ax.transAxes,
